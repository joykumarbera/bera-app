...
function EditBLog() {
  ...
  React.useEffect(() => {
    ...
    fetch(`/api/blogs/${blog_id}`).then(res => res.json()).then(res => {
      setBlog(res.data);
    }).finally(() => {
      setIsLoading(false);
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h5", {
  ...
  }, "Update Blog - ", blog?.title), /*#__PURE__*/React.createElement("div", {
    className: "container"
    ...
    className: "form-label"
  }, "Content"), !isLoading && /*#__PURE__*/React.createElement(Editor, {
  ...
  })), currentFeatureImageUrl != '' && /*#__PURE__*/React.createElement("div", {
    className: "text-center"
  }, /*#__PURE__*/React.createElement("img", {
    src: currentFeatureImageUrl
  })))), /*#__PURE__*/React.createElement("div", {
    className: "card mb-4"
  }, /*#__PURE__*/React.createElement("div", {
    className: "card-body"
    ...
    disabled: isLoading,
    onClick: e => updateBlog()
  }, isLoading ? 'Saving...' : 'Update'), !isLoading && /*#__PURE__*/React.createElement("a", {
    href: previewUrl,
    className: "btn btn-outline-primary mt-3 mb-2 ms-3",
    target: "_blank"
  }, "Preview")));
}
